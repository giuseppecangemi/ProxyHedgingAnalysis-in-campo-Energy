...
def variabili_returns():
    ...
    prezzo_spot = pd.read_excel(r"C:\Users\giucan03\OneDrive - Robert Half\Documents\Project\RISK\PROXY HEDGING\Py\ProxyHedging_Analysis\data.xlsx")
    prezzo_spot = pd.Series(prezzo_spot['psv_eur'].values, index=prezzo_spot['data'])
    uk_naturalgas = pd.read_excel(r"C:\Users\giucan03\OneDrive - Robert Half\Documents\Project\RISK\PROXY HEDGING\Py\ProxyHedging_Analysis\Natural Gas Futures Historical Data UK.xlsx")
